        ...
        for epoch in range(1, self.train_config['num_epochs'] + 1):
            ...
            while dataloader.has_next():
                ...
                if steps % self.train_config['steps_per_checkpoint'] == 0:
                    print(f'[EMBED] Epoch {epoch:02d} - Training smooth loss: {smooth_loss:.5f}\n\n')
                    smooth_loss = 0.0
                    torch.save(self.embeddings.state_dict(), f'{self.train_config["log_dir"]}/transe_model_sd_epoch_{epoch}.ckpt')
